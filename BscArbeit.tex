...
A proof of this theorem will be given later in \ldots

Finally a \emph{metric graph} is a finite connected graph with 
\todo{graph metric, path metric}
...
Now we can define a map from Outer space $\mathcal{X}_{n}$ to the infinite projective space $\mathbbm{RP}^{\mathcal{C}}$.
...
a disjoint union of open simplices: 
